...
\texttt{integrable\_norm\_sq\_mul\_exp\_neg\_mul\_norm\_sq} (supplied here, since Mathlib has
only the base $n$-dim Gaussian and the $1$-D moments). The kernel's time derivative is fed in
