...
conservation law underlying the energy method; the global uniqueness theorem
(\emph{equal initial data $\Rightarrow$ equal solutions}) follows by integrating over a
backward characteristic cone, a natural next target.
